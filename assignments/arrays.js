...
let lastCar = 0;
console.log("The make of the last car in the inventory is " + inventory[(inventory.length - 1)].car_make + " and the model is " + inventory[(inventory.length -1)].car_model + ".");
...
const ans = JSON.stringify(BMWAndAudi);
console.log(ans);
